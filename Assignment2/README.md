...
Σαν εργασία δεν θα την χαρακτήριζα δύσκολη στην υλοποίηση της ήταν αρκετά straight forward και τα ερωτήματα ήταν ξεκάθαρα το τι ζητάνε . Ωστόσο η πληθώρα των διαφορετικών συνδυασμών παραμέτρων που μπορούσαμε να πειράξουμε στο κάθε benchmark αν όχι άπειρη ήταν πολύ μεγάλη , κάτι το οποίο είναι χρονοβόρο και όταν έχεις ένα dead line πρέπει η κάθε αλλαγή που κάνεις να μετράει.

Οι μονές δυσκολίες που αντιμετωπίσαμε ήταν ότι μέχρι την ολοκλήρωση των 4/5 benchmark δεν είχαμε καταφέρει να κάνουμε το Hmmer να τρέξει. Αλλά με την βοήθεια των φοιτητικών forums το ξεπεράσαμε. Η άλλη δυσκολία ήταν ότι το vm crashαρε αρκετές φορές με αποτέλεσμα να σπαταλάμε χρόνο στον ελέγχω των τιμών που έχουμε πάρει και ποιες πρέπει να ξανά κάνουμε. 

Σαν μια γενική κριτική του μαθήματος μέχρι στιγμής θεωρό ότι είναι πολύ ενδιαφέρων ,γιατί πολλά ερωτήματα δεν έχουν ξεκάθαρη και σωστή απάντηση .  Το οποίο έχει σαν αποτέλεσμά να σε κάνει ψάξεις περεταίρω πληροφορίες για την αρχιτεκτονική και τους μοντέρνους υπολογιστές.

Μάλιστα ψάχνοντας περεταίρω πληροφορίες για το scaling έπεσα πάνω σε ένα [άρθρο]( https://www.extremetech.com/computing/116561-the-death-of-cpu-scaling-from-one-core-to-many-and-why-were-still-stuck) το οποίο παραθέτει την αύξηση του CPU clock speed ανά τα χρονιά. Και βλέπουμε ότι έχουμε φτάσει σε πλαφόν τιμών με την τωρινή τεχνολογία που έχουμε. Το οποίο το είδαμε και στην πράξη με αυτήν την εργασία .Δηλαδή με ότι αλλαγή και να κάναμε δεν παρατηρούσαμε τρέλες διάφορες στους χρόνους. 
